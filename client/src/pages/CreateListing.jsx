    ...
    <main className='p-3 max-w-4xl mx-auto '>
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>  
                ...
                <input type="text" placeholder='Address' className='border p-3 rounded-lg' id="ddress"  required/>
            ...
            {  
                formData.imageUrls.length > 0 && formData.imageUrls.map((url,index)=>(
                    ...
                    <div key={url} className="flex justify-between p-3 border item-center ">
                        ...
                        <button type="button" onClick={()=>handleRemoveImage(index)}className="p-3 text-red-800 rounded-lg uppercase hover:opacity-75" > Delete</button>
                    </div>
